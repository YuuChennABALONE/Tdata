/* "AMCAX_API BoolBRepSection(const TopoShape& s1, const TopoShape& s2, bool perfomNow = true)\t @param perfomNow If true, the operation is performed immediately; if false, the Build() function has to be called manually\n\t @param s2 The tool shape\n\t @param s1 The argument shape\n\t @brief Compute the section of two shapes\n,\n",
      */
 #include<catch.hpp>
