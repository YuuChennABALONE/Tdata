/* "AMCAX_API BoolBRepSection(const TopoShape& s1, const Plane& p1, bool perfomNow = true)\t @param perfomNow If true, the operation is performed immediately; if false, the Build() function has to be called manually\n\t @param p1 The tool plane\n\t @param s1 The argument shape\n\t @brief Special case: compute the section of a shape and an infinite plane\n,\n",
      */
 #include<catch.hpp>
