/* "AMCAX_API GeneralTransformShape(const TopoShape& s, const GeneralTransformation3& t, bool copy = false)\t @param copy Whether the geometry of the shape is copied\n\t @param t The general transformation\n\t @param s The shape\n\t @brief Transform a shape by a general transformation\n,\n",
      */
 #include<catch.hpp>
